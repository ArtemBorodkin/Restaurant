				...
				<div class="row">
					...
					<div class="form-group row">
						<label class="col-2 col-form-label" for="fullDescription">Full
							Description:</label>
						<div class="col-10">
							<form:input class="form-control" id="fullDescription"
				...
				<div class="row">
					...
					<div class="form-group row">
						<label class="col-2 col-form-label" for="shortDescription">Short
							Description:</label>
						<div class="col-10">
							<form:input class="form-control" id="shortDescription"
						...
						<div class="col-10">
							<select class="form-control" id="component" name="component" multiple>
								<c:forEach var="component" items="${components}">
									<option value="${component.ms}">${component.id}). ${component.amount}${component.ms} ${component.ingredient}</option>
								</c:forEach>
							</select>
						</div>
					</div>
